...
export const TweetsGenerator = (data_list, max_per_page, chart_draw_div_id, fromDate, toDate, filterOptions = false, rangeType = null, pname = null ,tweetCount) => {
	//per page max (max_per_page)
	if(tweetCount){
		tweetCountMap = tweetCount
	}else{
		tweetCountMap=null;
	}
	...
	if (filterOptions===true) {
		filterOptions = '<div class="btn-group pull-text-top ml-auto"><button type="button"\
				...
				<div class="dropdown-menu dropdown-menu-right" style="z-index:10">\
				...
				<li class="dropdown-item clickable filter-pos-tweets filterTweets" value="pos|'+ fromDate + '|' + toDate + '|' + chart_draw_div_id + '|' + rangeType + '"   id="' + chart_draw_div_id + rangeType + '"> Positive Tweets</li>\
				<li class="dropdown-item clickable filter-neg-tweets filterTweets " value="neg|'+ fromDate + '|' + toDate + '|' + chart_draw_div_id + '|' + rangeType + '"   id="' + chart_draw_div_id + rangeType + '" > Negative Tweets</li>\
				<li class="dropdown-item clickable filter-neu-tweets filterTweets "  value="neu|'+ fromDate + '|' + toDate + '|' + chart_draw_div_id + '|' + rangeType + '"  id="' + chart_draw_div_id + rangeType + '">  Neutral Tweets</li>\
				<li class="dropdown-item clickable filter-normal-tweets filterTweets " value="normal|'+ fromDate + '|' + toDate + '|' + chart_draw_div_id + '|' + rangeType + '"   id="' + chart_draw_div_id + rangeType + '">Normal Tweets</li>\
	...
	$('#' + chart_draw_div_id).html('<div class="d-flex ml-auto">' + filterOptions + '</div><div id="' + tweetDiv + '" > </div><div> <div class="float-center mt-1" id="' + tweet_div_page_selection + '"></div>  </div>')
	...
	get_tweets_info_AjaxRequest(slice_tid_list, pname, function (result) {
...
export const get_tweets_info_AjaxRequest = (slice_tid_list, pname = null, callback) => {
	$.ajax({
