...
import { createProjectAPI, insertToNewKeyspace, getAllProject, setProjectNameOnClickOnSelect, checkIfAnyKeySpaceCreatingAPI, getProjectName, deleteProjectFromRecords, checkIfAnyAnalysisStoreGoingOn, getAnalysisDetailsFromProjectActivitesAPI, checkAnalysisExistorNot } from './helper.js';
import { getUserDetail, actionLog, toShowSelectedProject, removeVariableFromLocalStorage, displayErrorMsg, getUserID } from '../utilitiesJS/smatExtras.js';
...
var ProjectStatus;
var isClearToMakeProject = 1, projectPending = [], analysisStorePending = [], isClearToStoreAnalysis = 1, isAnalysisLoggerAlreadyRunning = 0;
