...
@section('content')
    ...
    <div class="mb-3 row justify-content-center">
        <form id="naInputInputs">
            ...
            <div id="naInputPanel" class="justify-content-center">
                ...
                <div class="form-group  dateinputForm my-0  mr-3  border smat-rounded d-flex px-2 py-1  bg-white">
                    <i class="far fa-calendar-alt mx-2 text-normal " style="margin-top:11px;"></i>
                    <input type="text" value="2020-12-22" class="form-control datepicker-here " name="fromDate"
                        id="fromDateNA" placeholder="From Date" onkeydown="return false;" style="border:0px;"
                        autocomplete="OFF" data-language='en' required>
                </div>
                <div class="form-group dateinputForm my-0  mr-3 border smat-rounded d-flex px-2 py-1  bg-white">
                    <i class="far fa-calendar-alt mx-2 text-normal" style="margin-top:11px;"></i>
                    <input type="text" value="2020-12-23" class="form-control datepicker-here " name="toDate" id="toDateNA"
                ...
                <div class="form-group  my-0  mr-3 border smat-rounded d-flex px-2 py-1  bg-white">
                    <select class="form-control" name="NAType" id="typeNA" required>
                ...
                {{-- <div
                    class="form-group  my-0  mr-2 border smat-rounded d-flex px-2 py-1  bg-white">
                ...
                <div class="d-flex">
                    <button class="btn smat-btn  smat-rounded  mx-1" id="submit-btn" type="submit"> <span>Generate</span>
                    </button>
                    <div class="mt-3 mx-2"> OR </div>
                    <button class="btn smat-btn  smat-rounded  mx-1" onclick="return false" id="importNA">
                        <span>Import</span> </button>
                </div>
            </div>
        </form>
    </div>
    <div class="row justify-content-center mt-5" id="hint" style="display: none">
        <div class="card " style="width:50%;">
            <div class="card-body d-flex text-center"
                style="border: 1px solid black;border-style: dotted;border-radius:24px;opacity:40%;">
                <div><h1> <i class="fa fa-search fa-5 mt-3" aria-hidden="true" ></i></h1></div>
                <div class="text-left mx-3">
                    Query by :- <b>Hashtag</b> ( use'#',example: #COVID19 ) or <b> Mention</b> ( use'@',example:
                    @narendramodi ) or <b> Keyword</b> (example: happy , select appropriate network choice with first entity
                    type being Keyword) or <b> User </b> (example: Bob, , select appropriate network choice with first
                    entity type being User)</div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="card shadow col-md-8" style="background: white">
            <div>
                <span class="mt-2 smat-box-title d-flex justify-content-center"> Active Networks</span>
            </div>
                <div class="card-body mt-3 mb-3 d-flex text-center" id="hint_inside_na_cards" style="border: 0.2px solid black;border-style: dotted;border-radius:24px;opacity:70%;">
                    <div><h1> <i class="fa fa-search fa-5 mt-3" aria-hidden="true" ></i></h1></div>
                    <div class="text-left mx-3">
                        Query by :- <b>Hashtag</b> ( use'#',example: #COVID19 ) or <b> Mention</b> ( use'@',example:
                        @narendramodi ) or <b> Keyword</b> (example: happy , select appropriate network choice with first entity
                        type being Keyword) or <b> User </b> (example: Bob, , select appropriate network choice with first
                        entity type being User ) <br /><br /><br /> <p class="d-flex justify-content-center">Move Networks from <b> &nbsp; My Networks &nbsp; </b> with a click to perform operations</p> </div>
                </div>
            <div class="row" id="naCards">
            </div>
        </div>
        <div class="col-md-4">
                <div class="card shadow card border smat-rounded" style="background: white">
                    <div class="card-body" style="border: 0.1px solid rgb(63, 155, 209);border-style: dotted;border-radius:24px;padding:2%">
                        <div class="row">
                            <div class="col-4">
                                <span class="m-1 d-flex justify-content-left smat-box-title"> My Networks</span>
                            </div>
                            <div class="col-4">
                                <span class="m-1 d-flex justify-content-left smat-box-title" id="modemsg" style=""></span>
                            </div>
                            <div class="col-1">
                                <a><i class="far fa-eye" style="opacity:100%;font-size:20px" id="netview"></i></a>
                            </div>
                            <div class="col-1">
                            <a><i class="far fa-trash-alt" style="opacity:30%;font-size:20px" id="netdel"></i></a>
                            </div>
                        </div>
                        <div class="table-responsive ">
                            <table class="table  table-bordered">
                                <tbody id="naStatusTable_query_track">
                                    <div id="mynetworks" style="display:none;height:200px"></div>
                                </tbody>
                            </table>
                        </div>
    ...
    <div class="mt-2" id="naPanel">
        ...
        <div id="queryDisplayer" style="display: none">
            <p class="smat-box-title-large m-0"> <span class="smat-value font-weight-bold text-center text-dark"
                    id="naShowingResForTitle"> </span> </p>
        </div>
        ...
        <div class="row" id="net-analysis-summary" style="display: none">
                    ...
                    <div class="card-body">
                        ...
                        <div class="smat-tabs" id="net-smat-tabs" style="display: none">
                            ...
                            <div class="tab-content " id="pills-tabContent">
                                <div class="tab-pane fade show active " id="netContentNA" role="tabpanel"
                                    aria-labelledby="netContentNA">
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item naTabs-2 ">
                                            <a class="nav-link smat-rounded " id="commTab" data-toggle="pill"
                                                href="#communityContent" role="tab" aria-controls="communityContent"
                                                aria-selected="false">Community Detection</a>
                                        </li>
                                        <li class="nav-item naTabs-2 ">
                                            <a class="nav-link smat-rounded " id="lpTabNA" data-toggle="pill"
                                                href="#lpContent" role="tab" aria-controls="lpContent"
                                                aria-selected="false">Link Prediction</a>
                                        </li>
                                        <li class="nav-item naTabs-2">
                                        ...
                                        <li class="ml-auto">
                                            <div class=" my-0  mr-2 border smat-rounded d-flex px-2   bg-white">
                                                ...
                                                <select class="form-control" name="NAEngine" id="networkEngineNA">
                                                    <option class="engineSelectorOption" value="networkx">Network X
                                                    </option>
                                        ...
                                        <li class=" ">
                                            ...
                                            <button class="btn btn-primary mx-2 smat-rounded    "
                                                id="show_summary_button">Show Summary </button>

                                        </li>
                                    </ul>
                                    <div class="tab-content " id="pills-tabContent">
                                        <div class="tab-pane fade show active " id="centrality_algo_choice" role="tabpanel"
                                            aria-labelledby="centralityContent">
                                            <div>
                                                <div class="text-dark mx-2">
                                                    Select Centrality Algorithm Choice
                                                </div>
                                                <label class="radio-inline mx-2 " id="degcen"><input type="radio"
                                                        name="centralityInlineRadioOptions" value="degcen" checked>&nbsp
                                                    Degree Centrality &nbsp &nbsp &nbsp
                                                </label>
                                                <label class="radio-inline mx-2  " id="pgcen"><input type="radio"
                                                        name="centralityInlineRadioOptions" value="pgcen">&nbsp Page Rank
                                                    Centrality
                                                </label>
                                                <label class="radio-inline mx-2  " id="btwncen"><input type="radio"
                                                        name="centralityInlineRadioOptions" value="btwncen">&nbsp Betweeness
                                                    Centrality</label>
                                                <label class="radio-inline mx-2 " id="evcen"><input type="radio"
                                                        name="centralityInlineRadioOptions" value="evcen">&nbsp EV
                                                    Centrality
                                                </label>
                                                <button type="submit" id="centrality_exec"
                                                    class="btn btn-danger smat-rounded ">Execute</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade  p-1 " id="communityContent" role="tabpanel"
                                            aria-labelledby="communityContent">
                                            <div>
                                                <div class="text-dark mx-2">
                                                    Select Community Algorithm Choice
                                                </div>

                                                <ul class="nav nav-pills mb-3" id="pills-tab communityoption"
                                                    role="tablist">
                                                    <li class="nav-item naTabs-2 mx-2">
                                                        <a class="nav-link active smat-rounded " id="async"
                                                            value="asyncFluidTab" data-toggle="pill"
                                                            href="#asyncFluidContent" role="tab"
                                                            aria-controls="asyncFluidContent" aria-selected="true" algo="async">Async
                                                            Fluidic</a>
                                                    </li>
                                                    <li class="nav-item naTabs-2 mx-2">
                                                        <a class="nav-link  smat-rounded " id="lpa" value="labelPropTab"
                                                            data-toggle="pill" href="#emptyContent" role="tab"
                                                            aria-controls="emptyContent" aria-selected="true" algo="lpa">Label
                                                            Propagation</a>
                                                    </li>
                                                    <li class="nav-item naTabs-2 mx-2">
                                                        <a class="nav-link fade show smat-rounded " id="grivan"
                                                            value="grivanNewmanTab" data-toggle="pill" href="#emptyContent"
                                                            role="tab" aria-controls="emptyContent"
                                                            aria-selected="true" algo="grivan">Grivan Newman</a>
                                                    </li>
                                                    <ul>
                                            ...
                                            <div class="tab-content " id="pills-tabContent">
                                                <div class="tab-pane fade show active  " id="asyncFluidContent"
                                                    role="tabpanel" aria-labelledby="asyncFluidContent">
                                                    <div class="d-flex">
                                                        <div
                                                            class="form-group   my-0  mr-2  border smat-rounded d-flex px-2   bg-white">

                                                            <input type="number"
                                                                class="form-control smat-rounded  naInputs "
                                                                id="noOfCommunities" placeholder="No. of Communities"
                                                                style="border:0px;">
                                                        </div>

                                                        <button type="submit" class="btn btn-danger mt-1     smat-rounded"
                                                            id="comm_exec">Execute</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade  p-1 " id="spContent" role="tabpanel"
                                            aria-labelledby="spContent">
                                            <div class="d-flex">
                                                <div class="form-group pull-left mx-1">
                                                    <label for="sourceSp">Source</label>
                                                    <div class="border smat-rounded">
                                                        <input type="text" class="form-control  naInputs smat-rounded "
                                                            id="sourceSp" placeholder="Enter source" style="border:0px;">
                                                    </div>
                                                </div>
                                                <div class="form-group  mx-1">
                                                    ...
                                                    <div class="border smat-rounded">
                                                        <input type="text" class="form-control  naInputs smat-rounded "
                                                            id="destSp" placeholder="Enter Destination" style="border:0px;">
                                                    </div>
                                                </div>
                                                <div class="form-group mx-1">
                                                    <label for="sourceSp">Select Algorithm</label>
                                                    <select class="form-control border smat-rounded " name="NAEngine"
                                                        id="spoption">
                                                        ...
                                                        <option id="apsp" value="AllPossibleShortestPath">All Possible
                                                            Shortest Path</option>
                                                    </select>
                                                </div>

                                                <div class="form-group mx-1">
                                                    <button type="submit" id="sp_exec" class="btn btn-danger smat-rounded "
                                                        style="margin-top:30px;">Execute</button>
                                                </div>
                                            </div>

                                            <div class="tab-content " id="pills-tabContent">
                                                <div class="tab-pane fade show  " id="kspContent" role="tabpanel"
                                                    aria-labelledby="kspContent">
                                                    Hello

                                                </div>
                                                <div class="tab-pane fade show  active " id="emptyContentSP" role="tabpanel"
                                                    aria-labelledby="emptyContentSP">
                                        ...
                                        <div class="tab-pane fade  p-1 " id="lpContent" role="tabpanel"
                                            aria-labelledby="lpContent">
                                            <div>
                                                <div class="text-dark mx-2">
                                                    Select Link Prediction Algorithm
                                                </div>
                                                <label class="radio-inline mx-2 " id="adamicadar"><input type="radio"
                                                        name="linkpredictionRadioOptions" value="adamicadar" checked>&nbsp
                                                    Adamic Adar
                                                </label>
                                                <label class="radio-inline mx-2  " id="jaccardcoeff"><input type="radio"
                                                        name="linkpredictionRadioOptions" value="jaccardcoeff">&nbsp Jaccard
                                                    Coefficient
                                                </label>
                                                <label class="radio-inline mx-2  " id="resourceallocation"><input
                                                        type="radio" name="linkpredictionRadioOptions"
                                                        value="resourceallocation">&nbsp Resource Allocation
                                                </label>
                                                <label class="radio-inline mx-2  " id="commonneighbor"><input type="radio"
                                                        name="linkpredictionRadioOptions" value="commonneighbor">&nbsp
                                                    Common Neighbors
                                                </label>
                                            </div>
                                            <div>
                                                <div class="d-flex">
                                                    <div class=" pull-left mx-1">
                                                        <div class="border smat-rounded">
                                                            <input type="text" class="form-control  naInputs smat-rounded "
                                                                id="link_source_node" placeholder="Enter source"
                                                                style="border:0px;">
                                                        </div>
                                                    </div>
                                                    <div class=" mx-1">
                                                        <div class="border smat-rounded">
                                                            <input type="text" class="form-control  naInputs smat-rounded "
                                                                id="nos_links_to_be_predicted"
                                                                placeholder="No. of links to be predicted"
                                                                style="border:0px;">
                                                        </div>
                                                    </div>

                                                    <div class=" mx-1">
                                                        <button type="submit" class="btn btn-danger smat-rounded mb-0"
                                                            id="link_prediction_exec">Execute</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade text-center p-1" id="unionContentNA" role="tabpanel"
                                    aria-labelledby="unionContentNA ">
                                    <div class="form-group mx-1">
                                        <button type="submit" class="btn btn-danger smat-rounded"
                                            id="union_exec">Execute</button>
                                        <button type="submit"
                                            class="btn btn-primary mx-2 smat-rounded float-right smat-rounded"
                                            id="show_summary_button_union">Show Summary</button>
                                    </div>
                                    <div id="union_displayer" style="height: 90%"> </div>
                                </div>
                                <div class="tab-pane fade text-center " id="interSecContentNA" role="tabpanel"
                                    aria-labelledby="interSecContentNA">
                                    <div class="form-group mx-1">
                                        <button type="submit" class="btn btn-danger smat-rounded"
                                            id="intersection_exec">Execute</button>
                                        <button type="submit"
                                            class="btn btn-primary mx-2 smat-rounded float-right smat-rounded"
                                            id="show_summary_button_intersection">Show Summary</button>
                                    </div>
                                    <div id="intersection_displayer" style="height: 90%"> </div>
                                </div>
                                <div class="tab-pane fade text-center" id="diffContentNA" role="tabpanel"
                                    aria-labelledby="diffContentNA">
                                    <div class="form-group mx-1">
                                        <input type="text" class="form-control border smat-rounded  naInputs "
                                            id="difference_sequence" placeholder="Card sequence comma separated"
                                            style="border:0px;">
                                        <button type="submit" class="btn btn-danger smat-rounded"
                                            id="difference_exec">Execute</button>
                                        <button type="submit"
                                            class="btn btn-primary mx-2 smat-rounded float-right smat-rounded"
                                            id="show_summary_button_difference">Show Summary</button>
                                    </div>
                                    <div id="difference_displayer" style="height: 90%"> </div>
                                </div>

                                <div class="tab-pane fade text-center" id="expansionContentNA" role="tabpanel"
                                    aria-labelledby="expansionContentNA">Active Users Tab
                                    <div class="form-group mx-1">
                                        <input type="text" class="form-control smat-rounded  naInputs "
                                            id="node_to_be_expanded"
                                            placeholder="Card sequence comma separated, Sample Input: NetworkID, NetworkID"
                                            style="border:0px;">
                                        <input type="text" class="form-control smat-rounded  naInputs " id="hops"
                                            placeholder="Card sequence comma separated" style="border:0px;">
                                        <button type="submit" class="btn btn-danger smat-rounded"
                                            id="expansion_exec">Execute</button>
                                    </div>
            ...
            <div class="col-sm-4 card shadow" id="card_summary" style="display:none;">
                ...
                <div class="d-flex" id="switch_toggle"> 
                   <button class="btn btn-primary buttonSwitch button3" id="show_analysis">Show Analysis</button><button class="btn btn-primary buttonSwitch button3" id="show_neighbors">Neighborhood</button>
                 </div>

                 <div class="NeighborsDiv" style="height:550px;overflow-x:auto;overflow-y:auto;display: none;"></div>

                <div id="analysis_summary_charts">
                ...
                <div class="analysis_summary_div" style="height:550px;overflow-x:auto;overflow-y:auto;">
    ...
    <div class="modal" id="delete_permission" role="dialog">
        ...
        <!-- Modal for delete permission from DB-->
        <div class="modal" id="delete_permission_db" role="dialog">
            <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <p>Are you sure to remove the network ? Proceeding with YES will remove the network permanently. Click on YES to proceed or NO to revert back.</p>
                    </div>
                    <div class="modal-footer">
    ...
    <div class=" modal" id="myModal_file_upload" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color:brown">Select a CSV file to be Uploaded. CSV file should be in the format as mentioned
                        in the module manual:-</p>
                        ...
                        <div class="col">
                            ...
                            <form method="post" id="upload_form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control border smat-rounded  naInputs "
                                        id="cardnamefileupload" placeholder="Give the network a name, here."
                                        style="border:0px;">
