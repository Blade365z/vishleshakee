...
<div class="smat-mainHeading ">
    ...
    <div class="row">
                ...
                <form id="projCreateForm">
                    ...
                    <div class="dFlexBut mb-3">
                        <div class="form-group  text-normal  border smat-rounded d-flex  mr-2 px-2 py-1  bg-white mb-0"
                            ...
                            <input type="text" class="form-control " name="query" id="projectName"
                                placeholder="Type a project name" style="border:0px;" value="SARS_2020" autocomplete="OFF" required>
                        </div>
                    ...
                    <div class="dFlexBut mb-2">
                        <div class="form-group  text-normal  border smat-rounded d-flex  mr-2 px-2 py-1  bg-white mb-0"
                            ...
                            <input type="text" class="form-control " name="" id="projectTagInput"
                                placeholder="Type a hashtag/keyword" style="border:0px;" autocomplete="OFF"    data-container="body" data-trigger="focus"
                                data-html="true" data-toggle="popover"  value="#covid19" data-placement="top"
                                data-content="Query by :- <b>Hashtag</b> ( use'#',example: #COVID19 ) or <b> Keyword</b> ( use '*',example: *pakistan ) " >
                        </div>
                        <div>
                            <button class="btn btn-primary mx-2 mt-1 smat-rounded" id="addProjectKeyboard"  onclick="return false">+ Add
                                keyword</button>
                        </div>
                    </div>
                    ...
                    <div class="border mb-2 " style="border-radius:24px;padding:10px;">
                        <textarea id="projectFormTextarea_id" class="form-control"  placeholder="Description of the project"
                            rows="3" style="border:0px;" required>A test project created for coronavirus related information.</textarea>
                    </div>
                    <div class="d-flex">
        ...
        <div class="col-sm-6">
            <div class="card card-body projectDiv"  id="projectConfirmDiv" style="display:none;">
                <div>
                ...
                <div class="text-dark">
                    <p class="m-0"> from: <span class="font-weight-bold" id="fromDateConfirm"></span>, to: <span class="font-weight-bold" id="toDateConfirm"></span> </p>
                ...
                <div class="text-muted"> 
                    Please select <=3 topics from the suggestions list.
                </div>
