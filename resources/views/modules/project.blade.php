...
{{--     
        ...
        <div class="col-sm-8 offset-md-2">
            <div> 
                <button class="btn btn-primary smat-rounded" id="openProjectFormBtn">+ Click here to create a new project</button>
            </div>
            <div class="confirmPanelCollapse" id="projectCreationForm" > 
                ...
                <div class=" d-flex" id="closeCreateProjectDiv" title="close"><span class="ml-auto" style="cursor:pointer">close <i class="fas fa-times "></i></span> </div>
                    ...
                    <form id="projCreateForm">
                        ...
                        <div class="dFlexBut mb-3" style="width:60%;"> 
                            <div
                                ...
                                <input type="text" class="form-control datepicker-here  projField smat-from " id="fromDateProj"
                        ...
                        <div class="border mb-2 " style="border-radius:24px;padding:10px;">
                            <textarea id="projectFormTextarea_id" class="form-control projField" placeholder="Description of the project"
            ...
            <div class="confirmPanelCollapse mt-3" id="projectConfirmDiv">
             ...
             <div class="confirmPanelCollapse" id="openProjectDiv">
                 ...
                 <div class="card card-body" >
                     ...
                     <div class="mt-2 pt-2 " > 
                        <h5 class="text-dark my-0"><span id="numberOfStories">0</span> Stories created under the project </h5>
                        <div id="listOfStoriesOFProjectDiv" class="mt-1" style="border-radius:24px;display:flex;flex-wrap:wrap;"> </div>
                    </div>
                     </div>
