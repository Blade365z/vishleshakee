        ...
        <div class="col-sm-9 ">
            <form class=" smat-search-form " id="publicSearchForm" action="home" method="GET" role="search">
                ...
                <div id="naInputPanel">
                    <div class="form-group  text-normal  border smat-rounded d-flex  mr-2 px-2 py-1  bg-white mb-0"
                        ...
                        <input type="text" class="form-control typeahead" name="query" id="queryLM"
                            placeholder="Search a Hashtag or Mention" style="border:0px;" autocomplete="OFF"
                    ...
                    <div class="d-flex">
                        <button class="btn smat-btn  smat-rounded  mx-1 " id="submit-btn" type="submit"> <span>Search</span>
                        </button>
                    </div>

                </div>
                {{-- <small class="text-muted">*Use the unique Userhandle to search by
                    mention. </small> --}}
            </form>

            <div class="dFlexBut mt-2">
                ...
                <div id="interval-buttons-public-div">
                    ...
                    <li class="btn  btn-outline interval-buttons-public  smat-rounded clickable mr-2" value="15"
                        id="15minsBtn">15 Mins</li>
                    <li class="btn  btn-outline clickable  smat-rounded interval-buttons-public  mx-2" value="30">30 Mins
                    </li>
                    <li class="btn  btn-outline clickable smat-rounded  interval-buttons-public  mx-2" value="45">45 Mins
                    </li>
            ...
            <div>
                <p class="smat-box-title-large m-0">Showing results for <span
                        class="smat-value font-weight-bold text-normal" id="publicCurrentQuery"> </span> </p>
            </div>

            <div class="card  mt-2" id="main-public-dash">
                <div class="card-body">
        ...
        <div class="col-sm-3">
            @if (Auth::check())
                ...
                <div class="card card-body  px-3 py-3 mb-4">
                    ...
                    <p class="m-0 text-dark font-weight-bold"><span> <i class="fa fa-user-circle mr-1"
                                aria-hidden="true"></i></span>Hello, <span id="smatUserName">user</span></p>
                    <p class="m-0 "><a href="project" class="clickable" id="seeProjectBtnHome">See Projects</a> | <span
                            class="clickable">Logout</span> </p>
                </div>
            ...
            <div class="homeRightPanelLarge" id="homeRightPanel">
                <div class="card  px-3 py-3">
                    <div>
                        <p class="smat-box-title mb-1 font-weight-bold"> Alerts <i
                                class="fa fa-exclamation-triangle mx-2  pulseBtn text-danger" aria-hidden="true"></i> </p>
                    </div>
                ...
                <div class="card  mt-4 px-3 py-3">
                    <div class="d-flex ">
                        ...
                        <div class="dropdown ml-auto ">
                            <button class="btn btn-white dropdown-toggle smat-rounded   py-0 px-2" type="button"
